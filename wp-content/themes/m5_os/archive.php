...
<div class="os-page-qa">
	...
	<ul class="nav nav-pills msi-post-tab-nav" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="msi-post-cat-0-tab" data-toggle="pill" href="#msi-post-cat-0" role="tab" aria-controls="msi-post-cat-0" aria-selected="true">Tất cả</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="msi-post-cat-1-tab" data-toggle="pill" href="#msi-post-cat-1" role="tab" aria-controls="msi-post-cat-1" aria-selected="true">Thông tin dịch vụ</a>
            </li>
            <li class="nav-item">
