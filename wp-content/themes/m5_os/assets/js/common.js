...
(function($, $w, $d, w, d, $b) {
    $(document).ready(function() {
        ...
        var inputFormUserEn = document.querySelectorAll('.form-group-custom .wpcf7-form-control-wrap.text-906');
        var inputFormCallEn = document.querySelectorAll('.form-group-custom .wpcf7-form-control-wrap.tel-835');
        var inputFormMailEn = document.querySelectorAll('.form-group-custom .wpcf7-form-control-wrap.email-692');
        
        var imgUser = document.createElement('img');
        var imgCall = document.createElement('img');
        var imgMail = document.createElement('img');
        
        var imgUserEn = document.createElement('img');
        var imgCallEn = document.createElement('img');
        var imgMailEn = document.createElement('img');

        imgUser.src = '../../../wp-content/themes/m5_os/assets/images/os/ic_form_user.svg';
        imgCall.src = '../../wp-content/themes/m5_os/assets/images/os/ic_form_call.svg';
        imgMail.src = '../../wp-content/themes/m5_os/assets/images/os/ic_form_mail.svg';

        imgUserEn.src = '../../../wp-content/themes/m5_os/assets/images/os/ic_form_user.svg';
        imgCallEn.src = '../../wp-content/themes/m5_os/assets/images/os/ic_form_call.svg';
        imgMailEn.src = '../../wp-content/themes/m5_os/assets/images/os/ic_form_mail.svg';
        ...
        inputFormUserEn.forEach(function(wrapper) {
            const img = document.createElement('img');
            img.src = imgUserEn.src;
            img.className = 'icon-inside-input';
        
            wrapper.appendChild(img);
        });

        inputFormCallEn.forEach(function(wrapper) {
            const img = document.createElement('img');
            img.src = imgCallEn.src;
            img.className = 'icon-inside-input';
        
            wrapper.appendChild(img);
        });

        inputFormMailEn.forEach(function(wrapper) {
            const img = document.createElement('img');
            img.src = imgMailEn.src;
            img.className = 'icon-inside-input';
        ...
        var $clinicSlider = $('.os-sun-slider');
        $clinicSlider.slick({
            slidesToShow: 3,
