			...
			<div class="header__info display-flex-center only-desktop">
				...
				<span class="header__search ">
					<form method="get" action="" role="search">
						...
						<div class="search-data">
							...
							<label>Search</label>
							<img class="icon-calendar" src="<?php bloginfo('wpurl'); ?>/wp-content/themes/m5_os/assets/images/os/icon-search.svg" alt="icon-calendar">
						</div>
					</form>
				</span>
				...
				<div class="header__lang only-desktop">
					...
					<?php if (!empty($translations)) : ?>
						<?php
							$url = get_bloginfo('wpurl') . '/wp-content/themes/m5_os/assets/images/os/';
