                ...
                <div class="col-12 col-md-4 mb-3">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="mailto:contact@vncrh.org.vn" class="content-info-subtitle">
                                contact@vncrh.org.vn
                            </a>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .w-form-custom .form-group input:first-child {
        color: #989898;
        background-image: url(<?php bloginfo('wpurl'); ?>.'/wp-content/themes/m5_os/assets/images/os/icon-form-name.svg');
