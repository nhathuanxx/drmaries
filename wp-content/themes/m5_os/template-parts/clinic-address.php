...
//     var $clinicSlider = $('.os-sun-slider'); // Thay vì chọn id, chọn class để khởi động slider

//     // Khởi động slick slider cho tất cả các phần tử có lớp sun-slider
//     $clinicSlider.slick({
//         slidesToShow: 3,
...
//     });
// });
//     var $slider = $('#clinic-slider');
//     $slider.slick(); // Khởi động slick slider
// document.getElementById('home-city').addEventListener('change', function() {
//     var selectedCity = $(this).val();
//         $slider.slick('slickUnfilter'); // Bỏ lọc trước đó
