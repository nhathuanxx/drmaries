    ...
    <div class="container">
                            ...
                            <a href="<?php the_permalink($team_id); ?>"
                                ...
                                <div class="list-doctors__slider_item-img col-12 col-lg-6 pl-0 pr-0">
                                    ...
                                    if (has_post_thumbnail($team_id)):
                                        ...
                                        $image_url = $link . '/wp-content/themes/m5_os/assets/images/os/icon-menu-item.svg';
                                    endif;
                                    ?>
                                ...
                                <div href="<?php echo get_permalink($team_id); ?>"
                                    ...
                                    <div class="list-doctors__slider_item-content_rate">
                                        <?php
                                            $rating_images = array(
                                                get_bloginfo('wpurl') . '/wp-content/themes/m5_os/assets/images/os/icon-star-4.svg',
                                                get_bloginfo('wpurl') . '/wp-content/themes/m5_os/assets/images/os/icon-star-4.5.svg',
                                                get_bloginfo('wpurl') . '/wp-content/themes/m5_os/assets/images/os/icon-star-5.svg'
                                            );
        ...
        <?php
            ...
            if ($current_language == 'vi') {
                $href = get_bloginfo('wpurl') . '/doi-ngu-msi/';
                $text = 'Xem tất cả bác sĩ';
            } elseif ($current_language == 'en') {
                $href = get_bloginfo('wpurl') . '/en/doi-ngu-msi';
                $text = 'See all our doctors';
            } else {
                $href = get_bloginfo('wpurl') . '/doi-ngu-msi/';
                $text = 'Xem tất cả bác sĩ';
            }
        ...
        <a href="<?php echo esc_url($href); ?>"
            ...
            <img class="list-doctors__see-more_next"
                src="<?php get_bloginfo('wpurl'); ?>/wp-content/themes/m5_os/assets/images/os/arrow_circle_right.svg"
